...
const RAW = [
  ...
  { id: 'calendar-1', asset: 'calendar', frame: 9, zFlip: 18.03, keys: [
    ...
    [18.03,   54.8,   91.8,  395,   39.0],
    [18.23,   55.1,   90.3,  390,   24.0],
    [18.47,   55.6,   88.8,  337,   39.0],
    [18.73,   55.4,   88.0,  335,   21.0],
    [19.00,   54.9,   87.9,  330,   21.0],
    [19.27,   54.3,   88.0,  331,   27.0],
    [19.53,   53.7,   87.9,  331,   39.0],
    [20.33,   54.8,   88.8,  331,   39.0],
    [20.87,   55.5,   87.4,  306,   39.0],
    [21.07,   55.5,   86.4,  296,   39.0],
    [21.27,   55.1,   85.3,  296,   39.0],
    [21.67,   53.4,   83.0,  301,   39.0],
    [22.07,   50.9,   80.0,  301,   39.0],
    [22.47,   49.4,   75.7,  262,   39.0],
    [22.87,   48.9,   69.7,  202,   39.0],
    [23.07,   49.0,   68.1,  189,   39.0],
    [23.54,   49.9,   67.3,  183,   39.0],
    [23.67,   50.1,   67.0,  181,   39.0],
  ] },
  ...
  { id: 'spark-3', asset: 'spark', frame: 10, zFlip: 23.44, keys: [
    ...
    [22.27,   44.7,    3.2,  246,  -24.0],
    [22.47,   46.2,    5.5,  246,  -21.0],
    [22.67,   46.2,    7.6,  256,  -21.0],
    [22.87,   46.3,    9.2,  256,  -21.0],
  ...
  { id: 'spark-5', asset: 'spark', frame: 10, zFlip: 25.44, keys: [
    ...
    [22.93,   33.4,   93.0,  180,  -40.5],
    [23.13,   34.3,   91.0,  180,  -40.5],
    [23.60,   36.0,   89.0,  158,  -40.5],
    [24.40,   40.0,   88.0,  158,  -40.5],
    [24.94,   41.3,   86.9,  158,  -40.5],
  ...
  { id: 'coin-1', asset: 'coin-d', frame: 12, zFlip: 30.73, keys: [
    [30.13,   94.5,   -4.0,  125,  -60.0],
    [30.23,   92.6,   -0.7,  134,  -60.0],
    [30.43,   88.9,    5.8,  125,  -60.0],
    [30.63,   86.9,    9.9,  125,  -60.0],
    [30.83,   85.9,   12.3,  125,  -60.0],
    [31.03,   85.3,   14.0,  117,  -60.0],
  ...
  { id: 'coin-3', asset: 'coin-b', frame: 12, zFlip: 33.37, keys: [
    ...
    [34.13,   48.6,   85.4,  154,   10.5],
    [34.33,   47.9,   83.8,  147,   10.5],
    [34.53,   47.3,   81.9,  137,    9.0],
  ...
  { id: 'cross-1', asset: 'cross', frame: 14, zFlip: 40.24, keys: [
    [39.04,   55.6,   -6.1,  221,   16.5],
    [39.40,   51.6,    4.6,  221,   16.5],
  ...
  { id: 'heart-1', asset: 'heart', frame: 15, zFlip: 48.5, keys: [
    ...
    [45.14,   62.1,    4.8,  188,  -36.0],
    [45.33,   62.5,    6.4,  188,  -36.0],
    [45.60,   62.7,    8.3,  178,  -36.0],
    [46.13,   63.1,   11.0,  170,  -37.5],
    [46.40,   63.3,   11.9,  168,  -37.5],
    [46.93,   63.3,   12.0,  168,  -37.5],
    [47.97,   59.0,    9.5,  170,  -37.5],
    [48.37,   57.9,    9.0,  156,  -33.0],
    [48.57,   57.9,    9.3,  151,  -33.0],
    [48.97,   58.3,   11.2,  151,  -33.0],
    [49.17,   58.3,   13.0,  153,  -37.5],
    [49.37,   58.0,   14.9,  153,  -37.5],
  ...
  { id: 'report-1', asset: 'report', frame: 16, zFlip: 53.27, keys: [
    ...
    [49.93,   81.2,   94.7,  272,  -49.5],
    [50.33,   82.5,   93.3,  274,  -49.5],
    [50.60,   83.8,   93.4,  272,  -49.5],
    [51.13,   83.6,   93.9,  266,  -49.5],
    [51.40,   82.6,   94.0,  266,  -49.5],
    [51.67,   81.7,   94.0,  266,  -49.5],
    [51.93,   81.1,   93.5,  266,  -49.5],
    [52.17,   81.2,   93.1,  263,  -49.5],
  ...
  { id: 'report-2', asset: 'report', frame: 16, zFlip: 52.67, keys: [
    ...
    [49.76,   20.0,    1.9,  182,   33.0],
    [49.96,   20.9,    2.5,  182,   33.0],
    [50.16,   21.6,    3.0,  237,   33.0],
    [50.37,   22.3,    3.4,  237,   33.0],
    [51.43,   24.3,    3.8,  255,   33.0],
    [51.70,   25.3,    4.2,  260,   33.0],
    [51.97,   26.9,    4.8,  287,   33.0],
  ...
  { id: 'milkpack-3', asset: 'milkpack', frame: 21, zFlip: 73.74, keys: [
    ...
    [74.10,   50.4,   92.4,  432,  -48.0],
    [74.37,   49.5,   91.3,  437,  -48.0],
    [74.64,   49.1,   90.6,  432,  -48.0],
    [74.90,   49.5,   90.3,  430,  -48.0],
    [75.17,   49.7,   89.1,  430,  -48.0],
    [75.44,   51.4,   89.4,  433,  -48.0],
    [75.70,   52.6,   89.0,  430,  -48.0],
